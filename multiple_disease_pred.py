...
if (selected == 'Diabetes Prediction'):
    ...
    # code for Prediction
    diab_diagnosis = ''
    profile_pic = current_dir / "diabetes.jpg"
    ...
    if st.button('Diabetes Test Result'):
        ...
        if (diab_prediction[0] == 1):
          ...
          diab_diagnosis = 'Dont worry...! The person is not diabetic'
...
if (selected == 'Heart Disease Prediction'):
    ...
    profile_pic = current_dir / "heart.jpg"
    profile_pic = Image.open(profile_pic)
    st.image(profile_pic, width=500)
    ...
    if st.button('Heart Disease Test Result'):
        ...
        if (heart_prediction[0] == 1):
          ...
          heart_diagnosis = 'Hurray! The person does not have any heart disease'
...
if (selected == "Parkinsons Prediction"):
    ...
    profile_pic = current_dir / "parkinson.jpg"
    profile_pic = Image.open(profile_pic)
    st.image(profile_pic, width=500)
    ...
    if st.button("Parkinson's Test Result"):
        ...
        if (parkinsons_prediction[0] == 1):
          ...
          parkinsons_diagnosis = "Need not to worry! The person does not have Parkinson's disease "
